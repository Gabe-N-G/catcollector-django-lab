...
SECRET_KEY = 'django-insecure-$dp=p5!q=#id^163*v*a(fgp#l$6r$amqwe4sdda^v-vof4@ci'
...
# Application definition (all built in)
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'main_app',
    # main app is what we made, rest framework is something we installed.
]
...
# dot noation for file stoarage FOLDER: catcollector FILE urls(.py)
ROOT_URLCONF = 'catcollector.urls'


# BUILT IN WILL CHANGE
TEMPLATES = [
    {
